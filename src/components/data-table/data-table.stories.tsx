...
const responsiveSizingRows: ResponsiveSizingStoryRow[] = [
  ...
  },
  {
    ...
    owner: "Nina",
    notes: "fullWidth uses the provided width as the minimum column size.",
  },
];

const responsiveSizingColumns: DataTableColumn<ResponsiveSizingStoryRow>[] = [
  {
    field: "code",
    headerName: "Code",
    width: 110,
...
const overflowColumns: DataTableColumn<OverflowStoryRow>[] = [
  {
    field: "ellipsis",
    headerName: "Ellipsis",
    width: 180,
